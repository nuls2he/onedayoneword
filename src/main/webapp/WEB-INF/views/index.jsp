...
<div class="wrapper">
	...
	<div class="main main-raised">
	        ...
	        <div class="container tim-container">
	            ...
	            <div id="images">
	                ...
	                <div class="row">
						<div class="col-sm-2">
	                        <h4>Rounded Image</h4>
	                        <img src="resources/img/avatar.jpg" alt="Rounded Image" class="img-rounded img-responsive">
	                    </div>
						<div class="col-sm-2 col-sm-offset-1">
	                        <h4>Circle Image</h4>
	                        <img src="resources/img/avatar.jpg" alt="Circle Image" class="img-circle img-responsive">
	                    </div>
						<div class="col-sm-2 col-sm-offset-1">
	                        <h4>Rounded Raised</h4>
	                        <img src="resources/img/avatar.jpg" alt="Raised Image" class="img-rounded img-responsive img-raised">
	                    </div>

	                    <div class="col-sm-2 col-sm-offset-1">
	                        <h4>Circle Raised</h4>
	                        <img src="resources/img/avatar.jpg" alt="Thumbnail Image" class="img-circle img-raised img-responsive">
	                    </div>
	                </div>
	                <div class="row">
		...
		<div class="section section-full-screen section-signup" style="background-image: url('resources/img/city.jpg'); background-size: cover; background-position: top center; min-height: 700px;">
			<div class="container">
				<div class="row">
	            ...
	            <div class="row">
	                <div class="col-md-6">
	                    <a href="examples/landing-page.html" target="_blank">
	                        <img src="resources/img/landing.jpg" alt="Rounded Image" class="img-rounded img-raised img-responsive">
	                        <button class="btn  btn-simple btn-primary btn-lg">View Landing Page</button>
	                    </a>
	                </div>
	                <div class="col-md-6">
	                    <a href="examples/profile-page.html" target="_blank">
	                        <img src="resources/img/profile.jpg" alt="Rounded Image" class="img-rounded img-raised img-responsive">
